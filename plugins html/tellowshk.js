...
(function (scope) {
    ...
    const PLUGIN_CONFIG = {
        ...
        name: 'TellowsHK',
        version: '5.6.0',
        description: 'Queries hk.tellows.asia for phone number information using Regex.',
    ...
    function generateOutput(phoneNumber, nationalNumber, e164Number, requestId) {
        ...
        const targetSearchUrl = `https://hk.tellows.asia/num/${encodeURIComponent(numberToQuery)}?lang=en`;
