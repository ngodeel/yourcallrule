...
(function (scope) {
    ...
    const PLUGIN_CONFIG = {
        ...
        name: 'TellowsAR',
        version: '5.6.0', 
        description: 'Queries sa.tellows.net for phone number information using Regex.',
    ...
    const manualMapping = {
        'غير معروف': 'Unknown', 'رقم موثوق': 'Other', 'اليانصيب': 'Spam Likely',
        'شركة تحصيل ديون': 'Debt Collection', 'إعلانات عدوانية': 'Telemarketing', 'دراسة': 'Survey',
        'تحرش': 'Spam Likely', 'مصيدة تكاليف': 'Fraud Scam Likely', 'مسوق عبر الهاتف': 'Telemarketing',
        'بينغ نداء': 'Spam Likely', 'احتيال النص': 'Fraud Scam Likely', 'مكالمة احتيالية': 'Fraud Scam Likely',
        'اتصالات بعد منتصف الليل': 'Spam Likely', 'مزعج': 'Spam Likely', 'مسابقة': 'Other',
        'تهديد': 'Fraud Scam Likely', 'غير محدد': 'Unknown', 'Unknown': 'Unknown',
        'Trustworthy number': 'Other', 'Sweepstakes, lottery': 'Spam Likely',
        ...
        'Spam Call': 'Spam Likely', 'Phishing': 'Fraud Scam Likely'
    };
    ...
    function generateOutput(phoneNumber, nationalNumber, e164Number, requestId) {
        ...
        const targetSearchUrl = `https://sa.tellows.net/num/${encodeURIComponent(numberToQuery)}?lang=en`;
