// [slicklyMYID.js] - Slick.ly MY/ID Plugin (Pure FlutterJS Regex V6.2)
// =======================================================================================
...
(function (scope) {
    ...
    const PLUGIN_CONFIG = {
        id: 'slicklyMyIdPhoneNumberPlugin',
        name: 'Slick.ly MY/ID (Regex)',
        version: '6.2.0',
        description: 'Queries Slick.ly (MY/ID) for phone number information using Regex.',
        config: {
    ...
    const manualMapping = {
        'Berbahaya': 'Risk', 'Mencurigakan': 'Spam Likely', 'Aman': 'Other',
        'Penipuan': 'Fraud Scam Likely', 'Scam': 'Fraud Scam Likely', 'Tipu': 'Fraud Scam Likely',
        'Jebakan': 'Fraud Scam Likely', 'Penipu': 'Fraud Scam Likely', 'Spam': 'Spam Likely',
        'Junk': 'Spam Likely', 'Promosi': 'Telemarketing', 'Iklan': 'Telemarketing',
        'Telemarketing': 'Telemarketing', 'Pemasaran Telepon': 'Telemarketing',
        'Jualan Telepon': 'Telemarketing', 'Panggilan Robot': 'Robocall',
        'Panggilan Otomatis': 'Robocall', 'Robot': 'Robocall', 'Pengiriman': 'Delivery',
        'Hantaran': 'Delivery', 'Penghantaran': 'Delivery',
        'Makanan untuk Dibawa Pulang': 'Takeaway', 'Takeaway': 'Takeaway', 'Bungkus': 'Takeaway',
        'Nebeng': 'Ridesharing', 'Tumpang Kereta': 'Ridesharing', 'Berkongsi Kereta': 'Ridesharing',
        'Asuransi': 'Insurance', 'Insuran': 'Insurance', 'Perlindungan': 'Insurance',
        'Pinjaman': 'Loan', 'Hutang': 'Loan', 'Kredit': 'Loan',
        'Layanan Pelanggan': 'Customer Service', 'Khidmat Pelanggan': 'Customer Service',
        'Bantuan': 'Customer Service', 'Tidak Diketahui': 'Unknown', 'Tidak Dikenal': 'Unknown',
        'Rahasia': 'Unknown', 'Keuangan': 'Financial', 'Wang': 'Financial',
        'Finansial': 'Financial', 'Bank': 'Bank', 'Perbankan': 'Bank', 'Akaun': 'Bank',
        'Pendidikan': 'Education', 'Pelajaran': 'Education', 'Sekolah': 'Education',
        'Medis': 'Medical', 'Kesehatan': 'Medical', 'Dokter': 'Medical',
        'Amal': 'Charity', 'Derma': 'Charity', 'Sumbangan': 'Charity',
        'Lain': 'Other', 'Lain-lain': 'Other', 'Pelbagai': 'Other',
        'Pengumpulan Hutang': 'Debt Collection', 'Tunggakan': 'Debt Collection',
        'Survei': 'Survey', 'Tinjauan': 'Survey', 'Soal Selidik': 'Survey',
        'Politik': 'Political', 'Pilihan Raya': 'Political', 'Parti Politik': 'Political',
        'E-Dagang': 'Ecommerce', 'Kedai Online': 'Ecommerce', 'Jualan Online': 'Ecommerce',
        'Risiko': 'Risk', 'Bahaya': 'Risk', 'Ancaman': 'Risk',
        'Agen': 'Agent', 'Wakil': 'Agent', 'Perantara': 'Agent',
        'Perekrut': 'Recruiter', 'HR': 'Recruiter', 'Sumber Manusia': 'Recruiter',
        'Pemburu Kepala': 'Headhunter', 'Pencari Bakat': 'Headhunter', 'Carian Eksekutif': 'Headhunter',
        'Diam di Telepon': 'Silent Call Voice Clone', 'Tiada Jawaban': 'Silent Call Voice Clone',
        'Klon Suara': 'Silent Call Voice Clone', 'Suara Palsu': 'Silent Call Voice Clone',
        'Tiruan Suara': 'Silent Call Voice Clone', 'Internet': 'Internet', 'Online': 'Internet',
        'Perjalanan dan Tiket': 'Travel Ticketing', 'Pelancongan': 'Travel Ticketing',
        'Tiket Penerbangan': 'Travel Ticketing', 'Perisian Aplikasi': 'Application Software',
        'Aplikasi': 'Application Software', 'Program': 'Application Software',
        'Hiburan': 'Entertainment', 'Pertunjukan': 'Entertainment', 'Wayang': 'Entertainment',
        'Pemerintah': 'Government', 'Negara': 'Government', 'Kerajaan': 'Government',
        'Layanan Setempat': 'Local Services', 'Perkhidmatan Tempatan': 'Local Services',
        'Layanan Perbandaran': 'Local Services', 'Industri Otomotif': 'Automotive Industry',
        'Automotif': 'Automotive Industry', 'Kereta': 'Automotive Industry',
        'Penyewaan Mobil': 'Car Rental', 'Sewa Kereta': 'Car Rental',
        'Penyewaan Kenderaan': 'Car Rental', 'Telekomunikasi': 'Telecommunication',
        'Komunikasi': 'Telecommunication', 'Telefoni': 'Telecommunication',
        'SCAMMER': 'Fraud Scam Likely'
    };

    const blockKeywords = [
        'Penipuan', 'Scam', 'Tipu', 'Jebakan', 'Penipu', 'Spam', 'Junk', 'Promosi',
        'Telemarketing', 'Pemasaran Telepon', 'Panggilan Robot', 'Pengumpulan Hutang',
        'Hutang', 'Berbahaya', 'Mencurigakan', 'SCAMMER'
    ];
    const allowKeywords = [
        'Pengiriman', 'Hantaran', 'Makanan untuk Dibawa Pulang', 'Takeaway', 'Bungkus',
        'Nebeng', 'Asuransi', 'Layanan Pelanggan', 'Khidmat Pelanggan', 'Aman'
    ];
    ...
    function handleResponse(response) {
        ...
        try {
            ...
            if (action === 'none') {
                if (['Berbahaya', 'Risiko', 'Mencurigakan'].includes(parsed.summaryLabel)) action = 'block';
                else if (parsed.summaryLabel === 'Aman') action = 'allow';
            }
